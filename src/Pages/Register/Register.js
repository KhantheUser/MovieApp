...
export default function Register() {
  ...
  return (
  <form style={{backgroundImage:'url("https://yi-files.s3.eu-west-1.amazonaws.com/products/1187000/1187484/1980461-full.jpg")',backgroundSize:'100%'}} className="bg-grey-lighter min-h-screen flex flex-col">
