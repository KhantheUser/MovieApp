  ...
  <div className='profile'>
      ...
      <div className="grid grid-cols-12 relative" style={{height:'100px',boxShadow:'2px 2px 8px rgba(0,0,0,0.1)',padding:'20px 0'}}>
         <div className='h-36 w-36  bg-white rounded-full overflow-hidden' style={{position:'absolute',top:'50%',left:'50%',transform:'translateY(-50%)',boxShadow:'2px 2px 10px rgba(0,0,0,0.1)'}}>
                  <div>
                    <img style={{height:'8rem ',width:'8rem' ,position:'relative',top:'8px',left:'8px' }} className="rounded-full" src="https://scontent.fhan5-6.fna.fbcdn.net/v/t1.15752-9/271195231_948846129090827_3682436811429002979_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=ae9488&_nc_ohc=tmUlZop2T4YAX-G8-xv&_nc_ht=scontent.fhan5-6.fna&oh=03_AVKkBV9LcxwIa5mCjDF5GYWWS3jFK8gsaxcKiLA6LBMxYg&oe=6309FB76" alt="" />
                  </div>
         </div>
